...
class _UpdateUserState extends State<UpdateUser> {
  ...
  String? _profileImageBase64; // To store the Base64 representation of the image
...
void initState() {
  ...
  if (user != null) {
    ...
    if (user.photo != null) {
      _imageUrl= user.photo!;
      try {
        _profileImage = File.fromRawPath(base64Decode(user.photo!));
      } catch (e) {
        _profileImage = null; // Handle decoding errors gracefully
      }
    }
  }
}
            ...
            children: [
              ListTile(
                ...
                onTap: () async {
                  ...
                  final Uri currentImageUri = Uri.parse(_imageUrl);
                  final String? currentImagePath = currentImageUri.pathSegments
                      .skipWhile((segment) => segment != 'gr-images')
                      .skip(1) // Skip 'gr-images'
  ...
  Future<void> _update() async {
    ...
    final updatedUser = grUser.User(
      id: currentUser!.id, // Assuming auto-increment
